        ...
        <div>
            ...
            <div className="card" style={{ marginBottom: 20 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, fontSize: 13 }}>
                    <div>
                        <div style={{ fontWeight: 600, color: 'var(--color-text-primary)', marginBottom: 8 }}>Required Excel Format:</div>
                        <ul style={{ color: 'var(--color-text-secondary)', lineHeight: 2, paddingLeft: 20 }}>
                            ...
                            <li>Column: <strong>reg_no</strong> (register number)</li>
                            <li>Column: <strong>name</strong> (student name)</li>
                    ...
                    <div>
                        ...
                        <ul style={{ color: 'var(--color-text-secondary)', lineHeight: 2, paddingLeft: 20 }}>
                            ...
                            <li>⏭️ Existing students (same reg_no) are <strong>skipped</strong> — no overwrites</li>
                            <li>✅ Zero duplicates — safe to re-import the same file</li>
                            <li>✅ Invalid rows are reported</li>
                            <li>✅ LeetCode usernames extracted automatically</li>
                        </ul>
                    </div>
                </div>
            </div>
